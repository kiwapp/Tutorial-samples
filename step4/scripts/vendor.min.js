...
(function(){
    ...
    iOS.prototype.exec = function(url){
        var _self = this;
...
(function(){
    ...
    **/
    ...
    function sendOffline(data){
        if(data.call === 'store_offline_entry' && data.data.type === 'custom'){
            data = data.data;
            var config = Object.create(null);

            if(data.url === undefined)
                new Error('You have to specify an url');
...
},{"../../utils/ajax":9,"./driver":2}],5:[function(require,module,exports){
'use strict';
(function(){
...
},{"../utils/utils":17,"./driver/android":1,"./driver/iOS":3,"./driver/web":4,"./stats/session":6,"./stats/stats":7}],6:[function(require,module,exports){
'use strict';
(function(){
    /**
    *  browserify modules dependencies
    **/
    ...
    var extend = require('../../utils/extend');
    var buildGetUrl = require('../../utils/buildGetUrl');
    ...
    Session.send = function sendSession(config){
        ...
        if(typeof config === 'object'){
            options = manageConfig(config, currentData);
            url = options.builtUrl || config.url;
        }
        else{
            url = config;
        }
    ...
    function manageConfig(config, data){
        var options = Object.create(null);
        if(config.method.toUpperCase() === 'GET'){
            options.builtUrl = config.url + buildGetUrl(data);
        }
...
},{"../../libs/md5":8,"../../utils/buildGetUrl":10,"../../utils/extend":12}],7:[function(require,module,exports){
'use strict';
(function(){
...
(function(){
    ...
    var buildGetUrl = require('./buildGetUrl');
    /**
     * Ajax method to imitate the ajax of jQuery
     * @param  {object} config The config of the ajax call
     * @return {object} The processed xhr
     */
            ...
            if (xhr.readyState === 4) {
              ...
              if (status === 200 || status === 0) {
                ...
                if(config.error !== undefined)
                    config.error(xhr.responseText, status);
              }
            }
        };

        xhr.open(config.type || 'get', config.url, config.async || false );

        if(config.type === 'post' || config.type === 'POST' ){
            xhr.open('POST', config.url, config.async || false );
            xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            xhr.send(buildGetUrl(config.data, true));
            return xhr;
        }
...
},{"./buildGetUrl":10}],10:[function(require,module,exports){
'use strict';
(function(){
...
},{"./ajax":9,"./event":11,"./extend":12,"./getDate":13,"./increaseCapability":14,"./loadJS":15,"./model":16}]},{},[5]);
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
(function(){
    "use strict";
    function EventEmitter(){
